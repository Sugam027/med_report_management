...
<body>
    ...
    <header>
        ...
        <div class="searchSetting">
            <?php if($role === 1): ?>
                <p style="font-size: 1.5rem">ADMIN Panel</p>
            <?php elseif($role === 2): ?>
                <p style="font-size: 1.5rem">DOCTOR Panel</p>
            <?php else: ?>
                <p style="font-size: 1.5rem">PATIENT panel</p>
            <?php endif; ?>
            <strong class="current-date"><?= date('l, F j, Y'); ?></strong>
            <div></div>
            <div class="setting">
    ...
    <div class="profileBackground" id="profileInfoModel">
        <a href="/user/profile?user_id=<?= $userId ?>" class="userProfile">
            <div class="profile">
        ...
        <a href="/user/edituser?user_id=<?= $userId ?>" class="editDetails">
